...
$filtre = filter_input(INPUT_GET, "l", FILTER_SANITIZE_STRING) ;
...
define("URL_APP", "https://www.l3info-2021.una-ufrsfa.ci") ;//http://l3info-2020.zds
...
function annuaireContents(string $filtre = ""): string{
    ...
    $lesCles = $filtre == "" ? $_SESSION["app"]["toutesLesDonnees"] : $_SESSION["app"]["listeDesEtudiantsFiltree"][$filtre] ; 
	/*
	if($filtre != ""):
		echo "<pre>" ;
		print_r($_SESSION["app"]["listeDesEtudiantsFiltree"]);
		echo "</pre>" ; 
	endif;
	//*/
			$url = URL_APP ;
...
function makeData(){
			...
			$_SESSION["app"]["lesDonnees"] = $lesDonnees ;
			$_SESSION["app"]["toutesLesDonnees"] = $dir ;
			$_SESSION["app"]["lettres"] = $lettres ;

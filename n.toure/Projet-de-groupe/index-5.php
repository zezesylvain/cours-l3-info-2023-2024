...
<div class="extra-block"> 
    ...
    <div class="row-nav">
        <div class="main">
        <h1 class="logo"><a href="index.php"><img alt="Eni Gma" src="images/logo.png"></a></h1>
        <nav>
           <ul class="menu">
...
<div class="block"> 
    ...
    <div class="main aligncenter">
          <div class="privacy">Enigma   &copy; 2013 <span>|</span> <a href="index-5.php" rel="nofollow">Privacy Policy</a> <span>|</span> <strong>Website Template designed by <a href="http://store.templatemonster.com?aff=netsib1">TemplateMonster.com</a></strong> </div>
        </div>
  </footer>
    </div>
</body>

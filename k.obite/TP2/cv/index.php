                ...
                <div class="content_section_text"> 
                    <p>
                        <ul>
                            <li>
                                <tt>   
                                    <h2>  <?php echo $presentation[0] ;?></h2> 
                                    seul on va certainement très vite. Mais enssemble on va plus loin, et surtout on apprend plus.
                                
                                </tt>
                            </li>

                            <li>
                                <tt><h2> <?php echo  $presentation[1] ;?></h2></tt> 
                           
                            </li>

                            <li>
                                <tt><h2> <?php echo  $presentation[2] ;?></tt>
                            ...
                            <li>
                                ...
                                <tt>
                                    <h2> <?php echo  $presentation[3] ;?> </h2>
                                    la créativité faire partie de moi, j'aime cela et je  suis résolu à m'en servir convenablement.
                                </tt>
                            </li>
                        </ul>
                    <p>       

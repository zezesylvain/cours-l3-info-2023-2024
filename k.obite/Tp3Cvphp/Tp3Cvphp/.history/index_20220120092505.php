                ...
                <div style= "eight: 160px; padding-top: 10px; color: white; background-color: rgb(44, 43, 42);">
                    ...
                    <div class="row"> 
                       ...
                       <div class="col-md-6">
                            ...
                            <h2 style="color: rgb(229, 139, 21); text-align: right;" ><img style="width: 40px;height: 40px;" src="tele.png (2).p" class="info"><span style="margin-left: 5%"><?php echo $data['personne']['contact'] ;?></span></h2>

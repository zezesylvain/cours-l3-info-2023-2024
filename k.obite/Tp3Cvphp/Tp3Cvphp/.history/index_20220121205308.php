        ...
        <main  style= "box-shadow: 0px 0px 0px rgb(196, 196, 196), 0px 0px 0px rgb(196, 196, 196); margin: auto; width: 100%; height: 100%;">
            ...
            <div class="row">
                <div style= "text-align: center">
                    <section style="background-color: #fff;">
                        <hr style="order-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem; margin-left: 5% ; margin-bottom: 1rem;">
                        <h4 style="tex-align: center; color: #13c3ba; letter-spacing: .1rem; font-size: 25px;">ATOUTS</h4>
                        <hr style="order-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem; margin-left: 5% ; margin-bottom: 1rem;"><br><br>
            ...
            <div class="row">    
                <div style= "text-align: center" >   
                    <section style=" background-color: #fff;">
                        <hr style="order-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem; margin-left: 5% ; margin-bottom: 1rem;">
                        <h4 style="tex-align: center; color: #13c3ba; letter-spacing: .1rem; font-size: 25px;" >COMPETENCES</h4>
                        <hr style="order-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem; margin-left: 5% ; margin-bottom: 1rem;">
            ...
            <div>
                <div>
                    <div style= " text-align: center">
                        <section style="background-color: #fff;">
                            <hr style="order-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem; margin-left: 5% ; margin-bottom: 1rem;" class="light">
                            <h4 style="tex-align: center; color: #13c3ba; letter-spacing: .1rem; font-size: 25px;">DIPLOMES & FORMATIONS</h4>
                            <hr style="order-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem; margin-left: 5% ; margin-bottom: 1rem;" class="light">
                            <div class="row justify-content-between">
                                <div  style="margin-right: 60%;" class="div">
                                    ...
                                    <div class="md-6"; style="text-align: right; margin-top: -17%; margin-right: 10%">
                    ...
                    <div style= "text-align: center" >
                        <section style=" background-color: #fff;">
                            <hr style="order-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem; margin-left: 5% ; margin-bottom: 1rem;" class="light">
                            <h4 style="tex-align: center; color: #13c3ba; letter-spacing: .1rem; font-size: 25px;" >LANGUES</h4>
                            <hr style="order-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem; margin-left: 5% ; margin-bottom: 1rem;" class="light">
                ...
                <div style= "text-align: center">
                    <section style="background-color: #fff; ">
                            ...
                            <div class="row justify-content-between">
                                <div  style="margin-right: 60%;" class="div">
                                    ...
                                    <div class="md-6" style="text-align: right; margin-top: -12%; margin-right: 10%">
                    ...
                    <div style= "text-align: center" >
                        <section style=" background-color: #fff;">
                            <hr style="order-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem; margin-left: 5% ; margin-bottom: 1rem;" class="light">
                            <h4 style=" tex-align: center; color: #13c3ba; letter-spacing: .1rem; font-size: 25px;" >RESEAUX SOCIAUX </h4>
                            <hr style="order-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem; margin-left: 5%; margin-bottom: 1rem;" class="light"><br>
                            ...
                            <h4 style="tex-align: center; color: #13c3ba; letter-spacing: .1rem; font-size: 25px;" > CENTRE D'INTERET</h4>
                            <hr style="order-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem; margin-bottom: 1rem;" class="light">
                            <div class="row justify-content-between">
                                <div style="margin-right: 81%;" class="interet">
                                    <div class=" md-6"; style="text-align: left;  margin-left: 10%">
                                        ...
                                        <div class="md-6" style="text-align: right; margin-top: -10%; margin-right: 10%">   

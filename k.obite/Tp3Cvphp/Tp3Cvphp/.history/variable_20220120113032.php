...
//déclaration de variables donnant echo à mes expériences pro
    ...
    $fanglais=$data['fanglais']['fonctionOcc'];
    
//déclaration variable compétences, centre d'interet et reseaux sociauex

    $competence=$data['competence']['gb'];

    $langues=$data['langues']['fr'];

    $centreInteret=$data['centreInteret']['ft'];

        ...
        <section style="background-color: #fff; float: right; width: 400px;" class="section-right">
            ...
            <div style="padding: 0; width: 40%; margin-left: 10%;" class="skls">
                ...
                <div style="margin-left: 10%;" class="interet">
                    ...
                    <div><img  style="width: 20px;height: 20px;" src="mu.png.png" class="info" alt=""><span style="margin-left: 10%"><b><?php echo $data['centreInteret']['mu'] ;?></span></b></span></div>
                    <div><img  style="width: 20px;height: 20px;" src="le.png.png" class="info" alt=""><span style="margin-left: 10%"><b><?php echo $data['reseauxSociaux']['tw'] ;?></span></b></span></div>
                </div>

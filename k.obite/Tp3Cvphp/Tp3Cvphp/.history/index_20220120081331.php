    ...
    <main style= "box-shadow: 0px 0px 0px rgb(196, 196, 196), 0px 0px 0px rgb(196, 196, 196); margin: auto; width: 100%; height: 100%;">
        ...
        <!-- inclusion de l'entête du site -->
            ...
            <?php include_once('header.php'); ?>
              <h1>CV-<?php echo $data['personne']['nom']. " " .echo $data['personne']['nom'] ?></h1>
        ...
        <div class="row">
          <div class="col"> <br> <br>
                <div style= "eight: 160px; padding-top: 10px; color: white; background-color: rgb(44, 43, 42);">
                    ...
                    <div class="row"> 
                        <div class="col-md-6">
                            <h1 style="color: rgb(229, 139, 21); text-align: left;">OBITE Franck</h1><br>
                            <h2 style="color: rgb(229, 139, 21); text-align: left;" >INFORMATICIEN</h2> 
                       </div>
                       <div class="col-md-6">

                            <h1 style="color: rgb(229, 139, 21); text-align: right;">Obitefrank@gmail.com</h1><br>
                            <h2 style="color: rgb(229, 139, 21); text-align: right;" >07 57 49 25 78/ 05 56 02 86 92</h2>

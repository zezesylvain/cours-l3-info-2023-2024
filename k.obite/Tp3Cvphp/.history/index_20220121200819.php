                            ...
                            <div class="row justify-content-between">
                                <div  style="margin-right: 60%;" class="div">
                                    ...
                                    <div class="md-6" style="text-align: right; margin-top: -12%; margin-right: 10%">
                                        <p style="margin-right: 20%"><?php echo $data['fanglais']['annee'] ;?></p>
                                        <p><b style="margin-right: 12%"><?php echo $fanglais ;?></b><br>
                                        <strong style="color:orange;margin-right: 14.5%; text-decoration: none;"> <?php echo $data['fanglais']['lieu1'] ;?></strong><br>

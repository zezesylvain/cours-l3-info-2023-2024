...
<body class="d-flex flex-column min-vh-100"> 
    ...
    <div class="container">
        ...
        <main  class="container-fluid" style= "box-shadow: 0px 0px 0px rgb(196, 196, 196), 0px 0px 0px rgb(196, 196, 196); margin: auto; width: 100%; height: 100%;">
            ...
            <section style="background-color: #fff; float: left; width: 500px;" class="section-left">
            ...
            <section style="background-color: #fff; float: right; width: 500px;" class="section-right">

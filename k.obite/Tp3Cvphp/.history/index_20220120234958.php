            ...
            <div class="row">
                <div style= "text-align: left"; class="col-md-3">
                    <section style="background-color: #fff; float: left; width: 500px;">
                        ...
                        <div style="display: grid; grid-template-columns:repeat(1, 1fr); margin-left: 15%;">
                            <div><h5><?php echo $atouts ;?></h5><br></div><br><br>
            ...
            <div>
                <div style= "text-align: left"; class="col-md-9">
                    <section style="background-color: #fff; float: left; width: 500px;">
                        ...
                        <hr style="order-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem; margin-bottom: 1rem;" class="light">
                        <div style="padding-left: 5%"><?php echo $data['linfo']['annee'] ;?> </div>
                        <div style="padding-left: 5%"><b><?php echo $linfo ;?></b></div>
                        <strong style="padding-left: 5% color:orange; text-decoration: none;"> <?php echo $data['linfo']['lieu'] ;?></strong>
                        <br><br>
                        <div style="padding-left: 5%"><?php echo $data['cmoffice']['annee'] ;?></div>
                        <div style="padding-left: 5%"><b><?php echo $cmoffice ;?></b><br>
                            <strong style="padding-left: 5% color:orange; text-decoration: none;"><?php echo $data['cmoffice']['lieu'] ;?></strong> 
                        </div><br><br>
                        <div style="padding-left: 5%"></div><?php echo $data['bacc']['annee'] ;?>
                ...
                <div style= "text-align: right"; class="col-md-3" ></div>
                    <section style=" background-color: #fff; float: right; width: 500px;">
                        ...
                        <hr style="order-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem; margin-bottom: 1rem;" class="light">
                        <p style="margin-left: 5%"><?php echo $langues ;?></p>
                        <div style="background-color: #fff; border: 2px solid #ccc; width: 300px; height: 7px;" class="cool">
                            <div style=" width: 80%; height: 100%; background-color: orange;" class="inner"></div>
                        </div><br>
                        <p style="margin-left: 5%"><?php echo $data['langues']['ang'] ;?></p>
                        <div style="background-color: #fff; border: 2px solid #ccc; width: 300px; height: 7px;" class="cool">
                            <div style=" width: 50%; height: 100%; background-color: orange;" class="inner"></div>
                        </div>
                    </section>
                ...
                <div style= "text-align: left"; class="col-md-6">
                    <section style="background-color: #fff; float: left; width: 500px;">
                        <hr style="order-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem; margin-bottom: 1rem;" class="light">
                        <h4 style="margin-left: 15%; color: #13c3ba; letter-spacing: .1rem; font-size: 25px;">EXPERIENCES PROFESSIONELLES</h4>
                        <hr style="order-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem; margin-bottom: 1rem;;" class="light">
                    </section>
                </div>

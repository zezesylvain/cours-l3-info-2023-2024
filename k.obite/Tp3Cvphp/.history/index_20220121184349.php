...
<body class="d-flex flex-column min-vh-500"> 
    ...
    <div class="container">
        ...
        <main  style= "box-shadow: 0px 0px 0px rgb(196, 196, 196), 0px 0px 0px rgb(196, 196, 196); margin: auto; width: 100%; height: 100%;">
            ...
            <div style= "text-align: center" >   
                <section style=" background-color: #fff;">
                         style="order-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem; margin-left: 5% ; margin-bottom: 1rem;">
                        ...
                        <section style="background-color: #fff;">
                            ...
                            <div class="row">
                                <div  style="margin-right: 60%;" class="div">
                                    ...
                                    <div class="md-4"; style="text-align: right; margin-top: -20%; margin-right: 10%">

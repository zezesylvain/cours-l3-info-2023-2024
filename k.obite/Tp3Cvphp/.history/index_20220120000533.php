...
<body class="d-flex flex-column min-vh-100">
    <div class="container">
        ...
        <hr style="margin-left: 10%; color: #13c3ba; letter-spacing: .1rem; font-size: 18px;" class="light">
        ...
        <hr style="margin-left: 10%; color: #13c3ba; letter-spacing: .1rem; font-size: 18px;" class="light">
        <div style="display: grid; grid-template-columns:repeat(2, 1fr); margin-left: 10%;" class="div">
  ...
  <hr style="margin-left: 10%; color: #13c3ba; letter-spacing: .1rem; font-size: 18px;" class="light">
      ...
      <section style="background-color: #fff; float: right; width: 400px;" class="section-right">
        ...
        <h4>COMPETENCES</h4>
        <hr style="border-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem; margin-bottom: 1rem;" class="ligth">
        <div class="skls">
          <div class="po">
        ...
        <hr style="border-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem;
    margin-bottom: 1rem;" class="light">
        <h4>RESEAUX SOCIAUX</h4>
        <hr class="light">
        <div class="interet">
          <p><img src="f.png.png" class="info"><span>https://www.facebook.com/</span>
          </p>
          <p><img src="l.png.png" class="info"><span>https://linkdIn.com/...</span></p>
          <p><img src="g.png.png" class="info"><span> obite35</span></p>
          <p><img src="t.png.png" class="info"><span>https://www.twitter.com/pro_obi</span></p>
        </div>
        ...
        <hr class="light">
        <div class="interet">
          <div><img src="b.png.png" class="info" alt=""><span><b>Football</b></span></div>
          <div><img src="v.png.png" class="info" alt=""><span><b>Voyage</b></span></div>
          <div><img src="mu.png.png" class="info" alt=""><span><b>Musique</b></span></div>
          <div><img src="le.png.png" class="info" alt=""><span><b>Lecture</b></span></div>
        </div>

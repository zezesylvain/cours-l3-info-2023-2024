                ...
                <div style= "eight: 160px; padding-top: 10px; color: white; background-color: rgb(44, 43, 42);">
                    ...
                    <div class="row"> 
                       ...
                       <div class="col-md-6">
                            ...
                            <h1 style="color: rgb(229, 139, 21); text-align: right;"><?php echo $data['personne']['statu'] ;?></h1><br>
                            <h2 style="color: rgb(229, 139, 21); text-align: right;" ><?php echo $data['personne']['profession'] ;?></h2>

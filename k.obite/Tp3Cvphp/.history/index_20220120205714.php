...
<body class="d-flex flex-column min-vh-100"> 
    ...
    <div class="container">
        ...
        <main  style= "box-shadow: 0px 0px 0px rgb(196, 196, 196), 0px 0px 0px rgb(196, 196, 196); margin: auto; width: 100%; height: 100%;">
            ...
            <div class="row">
                <div class="col-md-6">
                    <section style="text-align: left; background-color: #fff; float: left; width: 500px;" class="section-left">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <section style=" text-align: right; background-color: #fff; float: right; width: 500px;" class="section-right">

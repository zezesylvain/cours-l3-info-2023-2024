            ...
            <div class="row">
                <div style= "text-align: left"; class="col-md-3">
                    <section style="background-color: #fff; float: left; width: 500px;">
                        ...
                        <h4 style="margin-left: 30%; color: #13c3ba; letter-spacing: .1rem; font-size: 25px;">ATOUTS</h4>
                        <hr style="order-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem; margin-bottom: 1rem;"><br>
                        <div style="display: grid; grid-template-columns:repeat(1, 1fr); margin-left: 15%;">
                            <div><h5><?php echo $atouts ;?></h5><br></div><br>
                            <div><h5><?php echo $data['atouts']['atdd'] ;?></h5></div><br>
                        </div>
                    </section>
                </div><
            ...
            <div>
                <div class="row">
                    ...
                    <div style= "text-align: right"; class="col-md-6" >
                        <section style=" background-color: #fff; float: right; width: 500px;">
                            <hr style="order-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem; margin-bottom: 1rem;" class="light">
                            <h4 style="margin-right: 20%; color: #13c3ba; letter-spacing: .1rem; font-size: 25px;" >LANGUES</h4>
                ...
                <div class="row">
                    ...
                    <div style= "text-align: right"; class="col-md-6" >
                        <section style=" background-color: #fff; float: right; width: 500px;">
                            <hr style="order-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem; margin-bottom: 1rem;" class="light">
                            <h4 style="margin-right: 20%; color: #13c3ba; letter-spacing: .1rem; font-size: 25px;" >RESEAUX SOCIAUX</h4>
                            <hr style="order-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem; margin-bottom: 1rem;" class="light"><br>
                            <div style="padding: 0; width: 40%; margin-left: 0%;" class="skls ">
                            ...
                            <hr style="order-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem; margin-bottom: 1rem;" class="light">
                            <h4 style="margin-right: 20%; color: #13c3ba; letter-spacing: .1rem; font-size: 25px;" > CENTRE D'INTERET</h4>
                            <hr style="order-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem; margin-bottom: 1rem;" class="light"><br>

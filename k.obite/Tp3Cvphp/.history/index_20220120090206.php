                ...
                <div style= "eight: 160px; padding-top: 10px; color: white; background-color: rgb(44, 43, 42);">
                    ...
                    <div class="row"> 
                       ...
                       <div class="col-md-6">
                            ...
                            <h3 style="color: rgb(229, 139, 21); text-align: right;"> <img style="width: 20px;height: 20px;" src="g.png.png" class="info"><span style="margin-left: 0%"><?php echo $data['personne']['statu'] ;?></span></h3><br>

...
<body class="d-flex flex-column min-vh-500"> 
    ...
    <div class="container">
        ...
        <main  style= "box-shadow: 0px 0px 0px rgb(196, 196, 196), 0px 0px 0px rgb(196, 196, 196); margin: auto; width: 100%; height: 100%;">
            ...
            <div class="row"> 
                <div class="col"> <br> <br>
                    <div style= "height: 160px; padding-top: 10px; color: white; background-color: rgb(74, 77, 42);">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-md-6">
                                ...
                                <h3 style="color: rgb(229, 139, 21); text-align: right; margin-right: 10% "> <img style="width: 30px;height: 30px;" src="g.png.png" class="info"><span style="margin-left: 5%"><?php echo $data['personne']['statu'] ;?></span></h3><br>
                                <h2 style="color: rgb(229, 139, 21); text-align: right; margin-right: 10%" ><img style="width: 40px;height: 40px;" src="tele.png (2).png" class="info"><span style="margin-left: 5%"><?php echo $data['personne']['contact'] ;?></span></h2>
            ...
            <div class="row">
                <div style= "text-align: center">
                    <section style="background-color: #fff;">
                        <hr style="border-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem; margin-left: 5% ; margin-bottom: 1rem;">
                        <h4 style="text-align: center; color: #13c3ba; letter-spacing: .1rem; font-size: 25px;">ATOUTS</h4>
                        <hr style="border-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem; margin-left: 5% ; margin-bottom: 1rem;"><br><br>
                        <div style="display: grid; grid-template-columns:repeat(1, 1fr); text-align: left; margin-left: 80px">
            ...
            <div class="row">    
                <div style= "text-align: center" >   
                    <section style=" background-color: #fff;">
                        <hr style="border-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem; margin-left: 5% ; margin-bottom: 1rem;">
                        <h4 style="text-align: center; color: #13c3ba; letter-spacing: .1rem; font-size: 25px;" >COMPETENCES</h4>
                        <hr style="border-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem; margin-left: 5% ; margin-bottom: 1rem;">
                        <div style="padding-left: 80px; width: 40%; margin-right: 20%;">
                            <div style="margin-top: 20px; ">
                                <p style=" margin-right: 40%"> <?php echo $competence ;?></p>
                                ...
                                <p style=" margin-right: 40%"> <?php echo $data['competence']['pw'] ;?></p>
                                <div style="background-color: #fff; border: 2px solid #ccc; width: 300px; height: 7px;">
                                    <div style="width: 70%; height: 100%; background-color: orange;"></div>
                                </div><br>
                                <div>
                                    <p style="margin-right: 40%"><?php echo $data['competence']['ia'] ;?></p>
                                ...
                                <div>
                                    <p style="margin-right: 45%"><?php echo $data['competence']['ms'] ;?></p>
                                    <div style="background-color: #fff; border: 2px solid #ccc; width: 300px; height: 7px;" class="cool">
            ...
            <div>
                <div>
                    <div style= " text-align: center">
                        <section style="background-color: #fff;">
                            <hr style="border-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem; margin-left: 5% ; margin-bottom: 1rem;" class="light">
                            <h4 style="text-align: center; color: #13c3ba; letter-spacing: .1rem; font-size: 25px;">DIPLOMES & FORMATIONS</h4>
                            <hr style="border-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem; margin-left: 5% ; margin-bottom: 1rem;" class="light">
                            <div class="row justify-content-between">
                                <div  style="margin-right: 60%;" class="div">
                                    <div class="md-6"; style="text-align: left;  margin-left: 10%">
                                        ...
                                        <div style="margin-right: 9.5%"><?php echo $data['bacc']['annee'] ;?></div>
                                        <div ><b style="margin-right: 2%"><?php echo $bacc ;?></b><br>
                                            <strong style="color:orange; text-decoration: none;"> <?php echo $data['bacc']['lieu'] ;?></strong> 
                                        </div><br><br>
                                        <div style="margin-right: 9.5%"><?php echo $data['bepc']['annee'] ;?></div>
                                        <div><b style="margin-right: -7%"><?php echo $bepc ;?></b><br>
                    ...
                    <div style= "text-align: center" >
                        <section style=" background-color: #fff;">
                            <hr style="border-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem; margin-left: 5% ; margin-bottom: 1rem;" class="light">
                            <h4 style="text-align: center; color: #13c3ba; letter-spacing: .1rem; font-size: 25px;" >LANGUES</h4>
                            <hr style="border-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem; margin-left: 5% ; margin-bottom: 1rem;" class="light">
                            <div style="padding: 0; width: 40%; margin-left: 7%;" class="skls ">
                                ...
                                <div style="margin-top: 20px;" class="po">
                                <p style="margin-right: 60%"><?php echo $data['langues']['ang'] ;?></p>
                                <div style="background-color: #fff; border: 2px solid #ccc; width: 300px; height: 7px;" class="cool">
                                    <div style=" width: 50%; height: 100%; background-color: orange;" class="inner"></div>
                                </div>
                            </div>    
                ...
                <div style= "text-align: center">
                            ...
                            <div class="row justify-content-between">
                                <div  style="margin-right: 60%;" class="div">
                                    <div class=" md-6"; style="text-align: left;  margin-left: 10%">
                                        ...
                                        <div style="margin-right: 20%"><?php echo $data['fanglais']['annee'] ;?></div>
                                        <p><b style="margin-right: 11.5%"><?php echo $fanglais ;?></b><br>
                                        <strong style="color:orange;margin-right: 14%; text-decoration: none;"> <?php echo $data['fanglais']['lieu1'] ;?></strong><br>
                    ...
                    <div style= "text-align: center" >
                        <section style=" background-color: #fff;">
                            <hr style="border-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem; margin-left: 5% ; margin-bottom: 1rem;" class="light">
                            <h4 style=" text-align: center; color: #13c3ba; letter-spacing: .1rem; font-size: 25px;" >RESEAUX SOCIAUX </h4>
                            <hr style="border-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem; margin-left: 5%; margin-bottom: 1rem;" class="light"><br>
                            ...
                            <hr style="border-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem; margin-bottom: 1rem;" class="light">
                            <h4 style="text-align: center; color: #13c3ba; letter-spacing: .1rem; font-size: 25px;" > CENTRE D'INTERET</h4>
                            <hr style="border-top: 2px solid #13c3ba; width: 90%; margin-top: .8rem; margin-bottom: 1rem;" class="light">
                            <div class="row justify-content-between">
